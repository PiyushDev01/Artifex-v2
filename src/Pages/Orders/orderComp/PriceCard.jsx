    ...
    <>
        ...
        id="outercontainer" className=' z-[10px] w-[300px] h-[435px] bg-[#3C3C3C] rounded-[30px] flex flex-col transition-all m-8 ' >
            ...
            <div id="bottomContent" className=' p-4 m-2'>
                ...
                <h2  id='cardDetail' className=' text-white'>Stay updated with regular progress notifications.</h2></div>

                <div className=' flex gap-2'>
                <h2 className=' text-white'>&#9737; </h2>
                <h2 id='cardDetail' className=' text-white'>Easily track the delivery status of your artwork.</h2></div>

                <div  id='cardDetail' className=' flex gap-2'>
                <h2 className=' text-white'>&#9737; </h2>
                <h2 className=' text-white'>Benefit from transparent payment and satisfaction guarantees.</h2></div>
