    ...
    <div id="formcontainer" className="flex flex-col md:flex-row w-full h-full rounded-md">
      <div id="leftform" className="flex flex-col p-2 md:w-1/2 w-full h-full gap-2">
            ...
            <h1
              ...
              className={`font-semibold text-left rounded-xl border md:border-2 cursor-pointer text-xs md:text-base py-1 px-4 ${
                is_F1_Invalide.size
                  ...
                  : clickedSizeIndex === index || details.size === item
            ...
            <h1
              ...
              className={`font-semibold text-left rounded-xl border md:border-2 cursor-pointer text-xs md:text-base py-1 px-4 ${
                is_F1_Invalide.orientation
                  ? "bg-[#ffb3b3] border-[#ff5050]"
                  : clickedOrientationIndex === index || details.orientation === item
                  ? " bg-purple-200 border-purple-500 outline outline-purple-500 "
                  : "border-gray-400"
              }  outline-[1px] hover:bg-slate-200 `}
        ...
        <label
          ...
          className="text-zinc-700 text-left text-xl font-semibold pt-4 py-1"
        >
          Additional Notes
        </label>
        <textarea
            ...
            >
              {image ? (
                <>
                  ...
                  <br />
                  <button
                    className="bg-mypurple text-white py-2 px-4 rounded-full shadow-lg"
                    onClick={handleCrop}
                  >
                    Crop
                  </button>
                ...
                <>
                  ...
                  <h1 className="text-slate-700 m-2 text-xs max-w-56">
                    ...
                    <h1 className="text-[#4A00E0] font-semibold">browse</h1> to choose a file
                  </h1>
                </>
              )}
            </div>
