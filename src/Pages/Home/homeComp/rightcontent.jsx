...
export default function Rightcontent(){
    return<>
    <div className="md:w-1/2 text-center h-full md:px-0 md:py-0 py-16 px-8 flex justify-center items-center  md:translate-x-0 md:translate-y-8 -translate-x-6 ">
      <motion.div variants={fadeIn("up",0.5)} initial="hidden" whileInView={"show"} viewport={{once:false,amount:0.4}} className=" w-fit md:w-full h-fit flex justify-center  relative">
