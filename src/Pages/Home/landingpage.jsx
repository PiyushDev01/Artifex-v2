...
{/*         
    ...
    <img className=' w-full absolute -z-20 top-0' src={blur1} alt="" />
    <img className=' w-full absolute -z-20 md:top-0 top-40' src={blur2} alt="" />
    <div className=" pt-40 md:pt-0  w-full  px-4 md:px-40 flex md:flex-row flex-col  " id='home' style={{height:"768px"}}>
    <Leftcontent/>
    <Rightcontent/>
    </div>
    </>;
